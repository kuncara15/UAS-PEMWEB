...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
		$sql = $connection->query("SELECT t.lama, m.harga FROM transaksi t JOIN sepeda m USING(id_sepeda) WHERE t.id_transaksi=$_POST[_id]");
		$r = $sql->fetch_assoc();
...
<div class="panel">
    ...
    <div class="panel-body">
        <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
            ...
            <button type="submit" class="btn simpan btn-block">Perpanjang</button>
            <a href="?page=profil" type="submit" class="btn btn-block">Batal</a>
