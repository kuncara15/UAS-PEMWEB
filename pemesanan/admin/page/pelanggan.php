	    ...
	    <div class="panel panel-<?= ($update) ?>">
	        ...
	        <div class="panel-body">
	            <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
	                ...
	                <?php if ($update): ?>
										<a href="?page=pelanggan" class="btn btn-block">Batal</a>
									<?php endif; ?>
	            </form>
	        </div>
	    </div>
	...
	<div class="col-md-9">
	    <div class="panel">
	        <div class="panel-heading">
	            <h3 class="text-center">DAFTAR PELANGGAN</h3></div>
	        <div class="panel-body">
	                    ...
	                    <?php if ($query = $connection->query("SELECT * FROM pelanggan")): ?>
	                        ...
	                        <tr>
	                            ...
	                            <td class="hidden-print">
	                                <div class="btn-group">
	                                    <a href="?page=pelanggan&action=update&key=<?=$row['id_pelanggan']?>" class="btn btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
	                                    <a href="?page=pelanggan&action=delete&key=<?=$row['id_pelanggan']?>" class="btn btn-xs">
