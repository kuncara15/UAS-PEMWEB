	    ...
	    <div class="panel panel-<?= ($update) ?>">
	        ...
	        <div class="panel-body">
	            <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
	                ...
	                <?php if ($update): ?>
										<a href="?page=jenis" class="btn  btn-block">Batal</a>
									<?php endif; ?>
	            </form>
	        </div>
	    </div>
	                    ...
	                    <?php if ($query = $connection->query("SELECT * FROM jenis")): ?>
	                        ...
	                        <tr>
	                            ...
	                            <td class="hidden-print">
	                                <div class="btn-group">
	                                    <a href="?page=jenis&action=update&key=<?=$row['id_jenis']?>" class="btn  btn-xs">
									<span class="glyphicon glyphicon-pencil"></span></a>
	                                    <a href="?page=jenis&action=delete&key=<?=$row['id_jenis']?>" class="btn btn-xs">
